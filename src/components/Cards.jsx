  ...
  return (
    <div className=''>
      <Card className=" px-6 rounded-2xl max-w-sm bg-blue-700 text-center ">
        ...
        <h2 className='flex justify-center font-semibold text-white text-4xl'>1500.$</h2>
        <p className="font-normal text-white text-center dark:text-gray-400">
          Install once
        </p>
        <div>
          <p className='text-white underline-extended'>10% Down Payment</p>
        </div>
        <div>
          <p className='text-white underline-extended'>Complete Installation</p>
        </div>
        <div>
          <p className='text-white underline-extended'>Hybrid</p>
        </div>
        <div>
