...
const MidCard = () => {
  return (
    ...
    <Card className=" px-6 rounded-2xl max-w-sm bg-blue-700 text-center ">
      ...
      <div>
        <p className='text-white underline-extended'>25% Down Payment</p>
      </div>
      <div>
        <p className='text-white underline-extended'>Full Coverage</p>
      </div>
      <div>
        <p className='text-white underline-extended'>Water System</p>
      </div>
      <div>
        <p className='text-white underline-extended'>Artificial Sunlight</p>
      </div>
      <Button>
        Read more
